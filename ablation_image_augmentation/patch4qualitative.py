...
for pred_dir in tqdm(pred_dirs):
	...
	pred_img_path = [os.path.join(os.getcwd(), 'qualitative', pred_dir, p) for p in os.listdir(os.path.join(os.getcwd(), 'qualitative', pred_dir)) if '94' in p][0]
	cropping(img_path=pred_img_path, save2=save22)
